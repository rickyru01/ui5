sap.ui.define([
    ...
    var StepInputController = Controller.extend("sap.m.sample.StepInput.StepInput", {
        ...
        onShowValue: function () {
            var oSI = this.getView().byId("si01")
            // MessageToast.show("call set default");
            console.log("show value:" + oSI.getValue());
            //MessageToast.show("set default called");
        },
        onSetDefault: function () {
            var oSI = this.getView().byId("si01")
            // MessageToast.show("call set default");
            console.log("show value before set:" + oSI.getValue());
            oSI.setValue(99);
            console.log("show value after set:" + oSI.getValue());
            //MessageToast.show("set default called");
        }
    });
